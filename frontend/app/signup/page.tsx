...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F4F6] flex flex-col justify-center items-center px-4 py-12 relative">
      ...
      <div className="w-full max-w-md bg-white p-8 rounded-3xl border border-[#E5E5EA] shadow-xl space-y-6">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900">Create your VedaAI Account</h2>
          <p className="text-xs text-[#8E8E93] font-semibold mt-1">Register your details to start compiling papers</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-[10px] font-bold uppercase tracking-wider text-gray-600 mb-1.5">Password (min 8 chars)</label>
            <input
              type="password"
              required
              minLength={8}
          ...
          <div>
            <label className="block text-[10px] font-bold uppercase tracking-wider text-gray-600 mb-1.5">School / College Name</label>
            <input
              type="text"
              required
              className="w-full px-4 py-2.5 text-xs rounded-xl bg-[#F4F4F6] border border-[#E5E5EA] focus:outline-none focus:border-[#FF5A36] focus:bg-white text-gray-900 transition font-medium"
          ...
          <div>
            <label className="block text-[10px] font-bold uppercase tracking-wider text-gray-600 mb-1.5">School City / Location</label>
            <input
              type="text"
              required
              className="w-full px-4 py-2.5 text-xs rounded-xl bg-[#F4F4F6] border border-[#E5E5EA] focus:outline-none focus:border-[#FF5A36] focus:bg-white text-gray-900 transition font-medium"
        ...
        <div className="text-center text-xs text-[#8E8E93] font-semibold pt-2 border-t border-[#F4F4F6]">
          ...
          <Link href="/login" className="text-[#FF5A36] hover:underline font-bold">
            Sign In
          </Link>
        </div>
      </div>
